...
>>>>>>> f969d8633b415fcdfb6d622c4ea0f883da37a66d
  ...
  addMessage('bot', 'Hi! My name is Amit, I can help you solve DSA problems. Ask me anything about the current problem!', chatMessages);
...
async function sendToGemini(userQuestion, problemInfo, chatMessagesElement) {
  try {
    ...
    const prompt = `
      ...
      Your name is Amit, You are a knowledgeable and supportive DSA (Data Structures and Algorithms) mentor and problem-solving assistant. Your goal is to guide the user toward understanding and solving coding problems rather than simply providing direct answers.
